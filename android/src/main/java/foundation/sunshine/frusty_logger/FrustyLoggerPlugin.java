package foundation.sunshine.frusty_logger;
...
/** FrustyLoggerPlugin */
public class FrustyLoggerPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  // continue supporting plugin registration via this function while apps
  // migrate to use the new Android APIs post-flutter-1.12 via
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel =
        new MethodChannel(registrar.messenger(), "frusty_logger");
    channel.setMethodCallHandler(new FrustyLoggerPlugin());
  }
